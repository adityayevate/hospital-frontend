      ...
      <div className="bg-primary-600 text-white py-3">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-wrap justify-between items-center text-sm">
          <div className="flex items-center space-x-8">
            <span className="flex items-center"><PhoneIcon className="h-4 w-4 mr-2" /> +91 98765 43210</span>
            <span className="flex items-center"><EnvelopeIcon className="h-4 w-4 mr-2" /> info@medicareplus.com</span>
          </div>
          <div className="flex items-center space-x-8 mt-2 sm:mt-0">
            <span className="flex items-center"><PhoneIcon className="h-4 w-4 mr-2" /> Emergency: +91 108</span>
