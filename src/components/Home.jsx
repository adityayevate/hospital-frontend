...
const testimonials = [
  {
    quote: "The online consultation feature saved me time. Doctors here are very helpful and supportive.",
    author: "Ananya Patil",
    role: "Patient",
    image: patient1
  },
  {
    quote: "Doctors explained everything clearly. The staff is very cooperative and friendly.",
    author: "Rohit Sharma",
    role: "Patient",
    image: patient1
  },
  {
    quote: "Booking appointments is easy and smooth. I highly recommend this hospital.",
...
const stats = [
  { label: 'Patients Treated', value: 8500, suffix: '+' },
  { label: 'Specialist Doctors', value: 25, suffix: '+' },
...
const Home = () => {
  ...
  Powered by Jalna Critical Care
</p>
  ...
  <img
    src={hospitalImg}
    alt="Jalna Critical Care Hospital"
