...
const stats = [
  ...
  { label: 'Medical Specialists', value: 45, suffix: '+' },
  { label: 'Patients Annually', value: 18000, suffix: '+' },
...
<div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100">
  <div className="h-72 overflow-hidden">
    <img 
      ...
      src={patient1}
      alt="Dr. Amit Kulkarni" 
    />
  </div>
  <div className="p-6">
    <h3 className="text-2xl font-bold text-gray-900 mb-2">Dr. Amit Kulkarni</h3>
    <p className="text-primary-600 font-medium mb-4">Chief Medical Officer</p>
    <p className="text-gray-600">
      Dr. Kulkarni brings over 20 years of experience in healthcare management and patient care excellence.
    </p>
  </div>
</div>
...
<div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100">
  ...
  <div className="p-6">
    ...
    <p className="text-gray-600">
      Dr. Sharma specializes in hospital administration and modern healthcare operations management.
    </p>
  </div>
</div>
...
<div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-100">
  <div className="h-72 overflow-hidden">
    <img 
      className="w-full h-full object-cover" 
      src={patient1}
      alt="Dr. Rahul Deshmukh" 
    />
  </div>
  <div className="p-6">
    <h3 className="text-2xl font-bold text-gray-900 mb-2">Dr. Rahul Deshmukh</h3>
    <p className="text-primary-600 font-medium mb-4">Head of Research</p>
    <p className="text-gray-600">
      Dr. Deshmukh leads innovative medical research and advanced treatment development programs.
    </p>
  </div>
</div>
          </div>
