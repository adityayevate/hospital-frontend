    ...
    const fetchAppointmentCounts = async () => {
      try {
        ...
        setDoctorInfo({
          ...
          patients: recentPatients.length // Placeholder
        });
...
const recentNotifications = [
  {
    message: 'New lab results available for Priya Sharma',
    time: '30 minutes ago',
  },
  {
    message: 'Appointment rescheduled by Raj Mehta to May 2',
    time: '2 hours ago',
  },
  {
    message: 'New message from Dr. Iyer about patient referral',
    time: 'Yesterday',
  }
];
    ...
    <div className="p-6">
      ...
      <div className="bg-gradient-to-r from-primary-500 to-primary-700 rounded-xl shadow-md mb-8 text-white p-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold">Welcome, Dr. {doctorInfo.name.split(' ')[1]}</h1>
